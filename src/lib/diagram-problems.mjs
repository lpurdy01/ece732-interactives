...
export const feedbackDiagram = {
  ...
  elements: [
    ...
    { id: 'gM', kind: 'gain', x: 290, y: 110, gain: '1/M', label: frac('1', 'M'), name: '1/M', out: 'dv', tone: 'physical', sym: 'm' },
    ...
    { id: 'gCa', kind: 'gain', x: 300, y: 30, h: 30, gain: 'C_a', label: 'C_{a}', name: 'C_a', out: 'F_Ca', tone: 'active', sym: 'Ca' },
    { id: 'gCp', kind: 'gain', x: 300, y: 65, h: 30, gain: 'C_p', label: 'C_{p}', name: 'C_p', out: 'F_Cp', tone: 'physical', sym: 'c' },
    { id: 'gKp', kind: 'gain', x: 300, y: 170, h: 30, gain: 'K_p', label: 'K_{p}', name: 'K_p', out: 'F_Kp', tone: 'physical', sym: 'k' },
    { id: 'gKa', kind: 'gain', x: 300, y: 210, h: 30, gain: 'K_a', label: 'K_{a}', name: 'K_a', out: 'F_Ka', tone: 'active', sym: 'Ka' },
  ],
  wires: [
